...
object MarshallableData:
  given IdenticallyTransmittable[MarshallableData] = IdenticallyTransmittable()
  given Serializable[MarshallableData] with
...
import MarshallableDataDefintions.given
